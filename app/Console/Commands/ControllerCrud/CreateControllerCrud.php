...
namespace App\Console\Commands\ControllerCrud;
...
// ----------------------------------
    ...
    public function handle()
    {
        ...
        if (!$this->modelPath){
            ...
            /*->setModelNamespacePath($this->modelPath)*/;
            ...
            /*->setLangModelNamespacePath($this->langModelPath)*/;
        }
        ...
        $filesAdded = [
            ...
            "app/resources/assets/js/components/{$lwModelPath}/* ".
    ...
    {
        $modelPath = app_path('Models/'.$this->modelPath.'.php');
        
        if(!is_file($modelPath) && $this->modelPath){

            Artisan::call('make:model', [
                'name' => 'Models/'.$this->modelPath,
            ]);
        }

        $langModelPath = app_path('Models/'.$this->langModelPath.'.php');

        if(!is_file($langModelPath) && $this->langModelPath){

            Artisan::call('make:model', [
                'name' => 'Models/'.$this->langModelPath,
            ]);
        }
    ...
    protected function componentJSContent()
    {
        ...
        $path = resource_path('assets/js/components.js');
        $content = '';
    ...
    protected function viewVueTemp()
    {
        ...
        $diffVueTmp = $this->getDifferentTemps(
            ...
            [
                ...
                'toPath' => resource_path("assets/js/components/"),
                'extension' => 'vue'
            ]
        );

...
import editPermissionFormComponent from './EditPermissionFormComponent';
...
export default {
  ...
  computed: {
    ...
    updateUrl: function(){
      return this.routes.index + '/' + this.datas.id + '/update-permissions';
    },
    editUrl: function(){
      return this.routes.index + `/${this.datas.id}/edit-permissions`;
    },
    isFormShow: function(){
  ...
  components: {
    ...
    'edit-permission-form-component': editPermissionFormComponent,
  }
}
</script>
  ...
  <div class="row">
    <div class="col-12">
      <div class="form-group">
        ...
        <div class="row mb-1" :key="uniqueID()+'-'+key" v-for="(item, key) in lawSubjects">
    ...
    $('.click2edit').summernote({
      callbacks: {
        onBlur: (e) => {
          ...
          this.lawSubjects[key] = e.target.textContent;
          console.log(this.lawSubjects);

          let arr = [...this.lawSubjects];

          this.lawSubjects.splice(0, this.lawSubjects.length);

          console.log(arr);
          
          arr.forEach((item) => {
            this.lawSubjects.push(item);
          })

          console.log(e.target.parentElement.parentElement.parentElement.querySelector('.click2edit').dataset.key);
